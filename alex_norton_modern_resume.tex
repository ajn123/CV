...
\cventry{Jan 2024 -- Present}{Graduate}{\college\ University}{Falls Church, VA}{}{}
\begin{itemize}
\item Master's degree with a concentration in data science, AI, and machine
  learning
\end{itemize}
\cventry{2011 -- 2015}{Undergraduate}{\college \ University}{Blacksburg, VA}{GPA: \textit{3.85/4.00}}{}  % arguments 3 to 6 can be left empty
\begin{itemize}
...
\cventry{2022-Present}{Software Engineer II}{Front Gate}{Remote}{}{PHP and Laravel
  development for TicketMaster backend systems}  % arguments 3 to 6 can be left empty
\begin{itemize}
...
\end{itemize}
\cventry{2021-2022}{Software Engineer}{Saatva}{Remote}{}{Ruby on Rails and React 
  frontend/backend development}  % arguments 3 to 6 can be left empty
\cventry{2019-2020}{Software Engineer}{Thoroughcare}{Remote}{}{Ruby on Rails and
  Vue.js Development with a small flexible team}  % arguments 3 to 6 can be left empty
\begin{itemize}
\item migrated the front end from html to Vue.js
\item performed complex SQL queries for testing in RSpec
\end{itemize}
\cventry{2015 - 2018}{Software Engineer}{IBM}{Austin, Texas}{}{ Developed
...
\section{Projects }
\cvitemwithcomment{RUN DMV}{Local Website to display local races and clubs in
  the District of Colombia area.}{Laravel, PHP}
\cvitemwithcomment{How I Met You}{Listing and adding events in the District of Columbia}{Alpine.js, Laravel, Tailwind, React}
...
%\end{itemize}
\cventry{2023-Present}{College Bound Mentor}{}{DC}{}{}  % arguments 3 to 6 can be left empty
\begin{itemize}
...
\cvlistdoubleitem{PHP/Laravel}{Tailwind/React/Alpine.js }
\cvlistdoubleitem{Python}{Ruby}
