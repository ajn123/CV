...
\cventry{2022-Present}{Software Engineer II}{Front Gate}{Remote}{}{PHP and Laravel
  development from TicketMaster backend systems}  % arguments 3 to 6 can be left empty
...
\item created SQL queries in the models to perform search and find for patients
...
\item worked on the frontend and API calls to return user to most recently read
  message.
\end{itemize}
