...
\recipient{\companyName \ Recruitment team}{\companyName \\123 somestreet\\some city}
\date{\today}
...
position with \companyName.   I graduate this December with a bachelor’s degree in
...
I have had three years of experience in Java.  I also have two years
experience in C, writing implementations of malloc(), web server, and a
simple shell.  I feel this knowledge of computer systems and optimization
knowledge will be a great benefit to the company.

In my software design capstone, a group of five of us created 
a Hadoop cluster that will automatically connect computers to
form a wireless cluster in a classroom so that resources from every
computer can be utilized to perform big data tasks.  The project will
require research on what needs to be done as well as collaboration with
Hadoop to understand this new technology.  My responsibilities include
project documentation, scripting automation, and overall high-level
design.
